package com.sigepro.web.security;
...
/**
 * Extends the baseline Spring Security JdbcDaoImpl and implements change password
 * functionality. Used in Chapter 4 example of customizing JdbcDaoImpl.
 * 
 * @author Mularien
 */
public class CustomJdbcDaoImpl extends JdbcDaoImpl implements IChangePassword {
    ...
    protected UserDetails createUserDetails(String username, UserDetails userFromUserQuery,
        ...
        return new SaltedUser(returnUsername, userFromUserQuery.getPassword(), userFromUserQuery.isEnabled(), true,
                true, true, combinedAuthorities, ((SaltedUser) userFromUserQuery).getSalt());
    }

    @Override
    protected List<UserDetails> loadUsersByUsername(String username) {
        // getUsersByUsernameQuery() <= esta es la query que pongo en la definicion del bean
